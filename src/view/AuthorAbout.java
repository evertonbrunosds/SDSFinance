...
public class AuthorAbout extends javax.swing.JDialog {
    ...
    public static void showModal(final java.awt.Frame parent) {
        instance = new AuthorAbout(parent, true);
    ...
    public static void main(final String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AuthorAbout.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            final AuthorAbout dialog = new AuthorAbout(new javax.swing.JFrame(), true);
